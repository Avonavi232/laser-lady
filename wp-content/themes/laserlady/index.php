    ...
    <section class="banners-slider banners-slider-section">
        <div class="banners-slider__container">
            <div class="js-banners-slider">
                <div>
                    <div class="banners-slider__item banner-id-1">
                </div>
                </div>
                <div>
                    <div class="banners-slider__item banner-id-1">
        ...
        <div class="container">
            ...
            <ol class="benefits">
                <li class="benefits__item">
                    ...
                    <p class="light benefits__item-content">Как правило, один сеанс лазерной эпиляции длится от нескольких минут до 1,5 часов, в зависимости от площади обрабатываемой поверхности</p>
                </li>
                <li class="benefits__item">
                    <h3 class="benefits__item-title title_1">Первые результаты видны после первого сеанса</h3>
                    <p class="light benefits__item-content">За одну секунду аппарат испускает три импульса на одну область. В промежутках между импульсами кожный покров имеет время на релаксацию, что увеличивает эффективность процедуры и снижает неприятные ощущения</p>
                </li>
                <li class="benefits__item">
                ...
                <li class="benefits__item">
                    ...
                    <p class="light benefits__item-content">При максимальной нагрузке стекло не нагревается выше 30 градусов, благодаря современной системе охлаждения CoolingPro. Поэтому на нашем лазере ожоги невозможны!</p>
                </li>
                <li class="benefits__item">
                    <h3 class="benefits__item-title title_1">Объединяет возможности других лазеров</h3>
                    <p class="light benefits__item-content">На данный момент, существует несколько видов лазеров. Диодный и александритовый лазер воздействуют на меланин. Неодимовый длинноимпульсный лазер воздействует на белок. IPLASER, в свою очередь, воздействеут и на меланин, и на белок, в связи с длиной волны света 755 - 1064 нм</p>
                </li>
            </ol>
        </div>
    </section>
                        ...
                        <div class="myths__item myth-item">
                            <div class="myth-item__header">
                                <h3 class="myth-item__title">
                                    ...
                                    После процедуры удаления, волосы вырастают еще более жесткие, их количество увеличивается
                                </h3>
                            </div>
                            <div class="myth-item__content">
                                <p class="light">Наоборот, количество волосков значительно сокращается, а проросшие волоски становятся тоньше.</p>
                            </div>
                        </div>
                        <div class="myths__item myth-item">
                            <div class="myth-item__header">
                            ...
                            <div class="myth-item__content">
                                <p class="light">Низкая стоимость расходных материалов, благодаря чему, использование аппаратов системы IPLASER доступно всем. Да, и только представьте, сколько обычно женщина тратит в год денег на покупку средств для депиляции (станки, кремы, пенки и т.д.). А за 5-10 лет? И посчитайте стоимость курса лазерной эпиляции, взглянув на наши цены (6-8 сеансов с интервалом в 1 месяц и все)</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="faq__content">
                <ul class="faq-questions js-faq-questions">
                    <li class="js-faq-question-container faq-questions__item">
                        ...
                        <div class="answer js-faq-answer">Все зависит от вашей чувствительности. Болевой порог у всех людей совершенно разный. Клиенты говорят, что ощущают легкие покалывания и тепло, и это нормально, ведь корень волоса и волосяной фолликул подвергаются интенсивному воздействию выделенного спектра света. Так или иначе, на сегодняшний день это наиболее комфортная процедура из имеющихся
                        </div>
                    </li>
                    <li class="js-faq-question-container faq-questions__item">
                        ...
                        <div class="answer js-faq-answer">
                            <ul class="custom-list">
                                <li>перед процедурой волосы на обратываемой зоне необходимо сбрить (станком или с помощью депиляционного крема). Лучше всегда за сутки до процедуры ( но, ни в коем случае, не в день ее проведения), чтобы длина волоска не превышала 1-2 мм., т.к. чем меньше волос, тем комфортнее процедура, т. к волос может сгорать под воздействием светового излучения</li>
                                <li>не загорайте за 5-7 дней до и после процедуры (в том числе и в солярии)</li>
                                <li>не травмируйте кожный покров 3 дня до и 3 дня после процедуры (не пользуйтесь скрабами, пилингами, жесткими мочалками, исключите походы в бани, сауны и бассейны)</li>
                            </ul>
                        </div>
                    </li>
                    <li class="js-faq-question-container faq-questions__item">
                        <div class="q js-faq-question">Через сколько времени ждать эффекта?</div>
                        <div class="answer js-faq-answer">Провели процедуру, теперь набираемся терпения и ждем. На следующий день ничего не произойдет. На второй и третий день тоже. Более того, может даже показаться, что волосы растут. Дело в том, что волосок под воздействиям лазера погиб и кожа его постепенно может выталкивать в течение нескольких дней. Спустя 2 недели начинается самое интересное и долгожданное - волосы начинают выпадать. В среднем, в течение месяца выпадет порядка 20-30% волос на обработанном участке. Далее начнут расти "проснувшиеся" волоски - ими мы и занимаемся на следующей процедуре.
                        </div>
                    </li>
                    <li class="js-faq-question-container faq-questions__item">
                        <div class="q js-faq-question">После 3-4 процедуры усиливается рост волос. Что делать?</div>
                        <div class="answer js-faq-answer">Главное не паниковать. Такая реакция абсолютно нормальная и физиологична, дело в том, что спящие луковицы, которые энергия световой волны не может удалить начинают просыпаться и давать рост. Реакция временная и нужно просто продолжать по назначенному курсу.
                        </div>
                    </li>
                    <li class="js-faq-question-container faq-questions__item">
                        <div class="q js-faq-question">Сколько процедур нужно, чтобы волосы перестали расти?</div>
                        <div class="answer js-faq-answer">Все очень индивидуально и точного ответа на этот вопрос нет. Зависит в первую очередь от цвета волос. Чем темнее волос, тем более эффективна процедура. Так же сильное влияние оказывает уровень гормонального фона на разных зонах и в организме в целом. В среднем количество процедур варьируется от 4 до 10.
                        </div>
                    </li>
                    <li class="js-faq-question-container faq-questions__item">
                        <div class="q js-faq-question">Волосы пропадут навсегда?</div>
                        <div class="answer js-faq-answer">Мы с вами откровенны! Лазерная эпиляция разрушает волосяной фолликул, но наш организм способен его восстановить. После полного курса вы можете на годы забыть про лишнюю растительность. Даже если рост волос возобновляется, то далеко не в полном объеме - это всего несколько тонких и светлых волосков, которые пропадут после 1-2х процедур. Поэтому примерно раз в год рекомендуется проходить закрепляющую процедуру.
                        </div>
                    </li>
                    <li class="js-faq-question-container faq-questions__item">
                        <div class="q js-faq-question">Каким образом удалять волосы между процедурами?</div>
                        <div class="answer js-faq-answer">Брить станком или электробритвой. Ни в коем случае не использовать воск и шугаринг. Фолликул волоса восстановится и наши усилия окажутся напрасными.
                        </div>
                    </li>
                    <li class="js-faq-question-container faq-questions__item">
                        <div class="q js-faq-question">Светлые волосы можно удалить лазером?</div>
                        <div class="answer js-faq-answer">Любая система для эпиляции, которая основана на световом импульсе, может удалять только темный волос. То есть лазер «не видит» светлый, седой или пушковый волосок и, соответственно, не устраняет его. Поэтому, если вы от природы блондинка, то лазерная эпиляция вам просто не поможет. Если волос содержит, хоть немного меланина (темного вещества) - тогда возможно.
                        </div>
                    </li>
                    <li class="js-faq-question-container faq-questions__item">
                        <div class="q js-faq-question">Есть ли противопоказания?</div>
                        <div class="answer js-faq-answer">Есть. К ним относятся: беременность, кормление грудью, эпилепсия и онкология, острые инфекционные заболевания, ишемическая болезнь сердца и гипертония. IPLASER эпиляция запрещена при наличии кардиостимулятора и слухового аппарата. При гормональных нарушениях в организме, подобная процедура также пользы не принесет. Не советуем делать эпиляцию при острой фазе герпеса. Он очень чувствителен к свету и его заживление может затянуться (или он появится в новых местах). Лучше приходить спустя 2 недели после заживления. С осторожностью следует делать лазерную эпиляцию при варикозном расширении вен и аллергии на свет. Но, тем не менее, в обоих случаях лазерная эпиляция возможна.
                        </div>
                    </li>
                </ul>
            </div>
                                            ...
                                            <div class="col-md-5 offset-md-7">
                                                <div class="master-item__description-content">
                                                    ...
                                                    <div class="master-item__description">
                                                        <p class="light">Лидия- лицензированный специалист, прошедший обучение в центре Innovatione г. Москва</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="col-sm-5">
                        <div class="contacts-section__contacts">
                            <div class="company-links">
                                ...
                                <div class="company-links__item">
                                    <a href="mailto:studia@gmail.com"
                                       class="company-links__item-link">studia@gmail.com</a>
                                </div>
                            </div>
